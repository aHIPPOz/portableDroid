...
SAMPLE = ROOT / "runtime/src/jsMain/kotlin/com/example/complex/MainActivity.kt"
REQUIRED = (
    ROOT / "docs/compatibility-contract.md",
    ROOT / "tools/android_api_indexer/generate_api_index.py",
    ROOT / "runtime/build.gradle.kts",
    ROOT / "runtime/src/jsMain/resources/manifest.webmanifest",
)
...
def main() -> int:
    ...
    required_imports = ("import android.app.Activity", "import android.os.Bundle", "import android.util.Log", "import android.widget.Button")
    if missing:
